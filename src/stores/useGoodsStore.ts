...
export const useGoodsStore = defineStore('goodsStore', () => {
  ...
  const hoodGoods = ref<Good[]>([
    ...
    },
    {
      ...
      count: 0,
      description: {
        text: 'Состав: Мука пшеничная, грибы (шампиньоны, вешенки), лук, спред, соус соевый, специи (черный перец, соль, специя чеснок). Срок хранения: 90 суток при t -8 -18',
        protain: 21,
        fat: 2.3,
        carbs: 37.2,
        kcal: 252,
