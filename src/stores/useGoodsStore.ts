...
export const useGoodsStore = defineStore('goodsStore', () => {
  ...
  const vegSkladSpecial = ref([
    {
      title: 'Сейтан Вегачикен 1 кг',
      image: 'specials/vegchicken.webp',
      weigth: 1000,
      price: 1000,
      count: 0,
      description: {
        text: 'Клейковина пшеничная  гидратированная, вода питьевая, масло кокосовое рафинированное дезодорированное, загустители: гуаровая камедь, каррагинан, тара камедь; соль пищевая, экстракт чили, стабилизатор, комплексная пищевая добавка: ароматизатор "Курица", декстроза',
        protein: 17,
        fat: 15,
        carbs: 5.5,
        kcal: 230,
    ...
    {
      title: 'Фарш Hi!',
      image: 'specials/mincemeat_HI!.webp',
      weigth: 400,
      price: 220,
      count: 0,
      description: {
        text: 'вода, текстурированный растительный белок (подсолнечный, соевый, гороховый), рафинированные дезодорированные растительные масла (рапсовое, кокосовое, подсолнечное), глюконат кальция, пищевые волокна, ароматизатор натуральный говядина, соль пищевая, глюкоза, концентрат пищевой сухой натуральный: Свекольный, чеснок молотый, краситель Сахарный колер I, перец черный молотый, антиокислитель - лимонная кислота, бисглицинат железа, витамин D3, витамин В12',
        protein: 10,
        fat: 15,
        carbs: 3.7,
        kcal: 197,
    ...
    {
      title: 'Наггетсы Hi!',
      image: 'specials/naggetsy_hi.webp',
      weigth: 200,
      price: 120,
      count: 0,
      description: {
        text: 'вода, рафинированные дезодорированные растительные масла (рапсовое, подсолнечное), текстурированный растительный белок (подсолнечный, соевый, гороховый), пищевые волокна, сухари панировочные (мука пшеничная, вода питьевая, краситель — Аннато), глюконат кальция, комплексная пищевая добавка «Льезон» (мука пшеничная, стабилизаторы (ксантановая камедь, камедь гуаровая, камедь рожкового дерева), ароматизатор «Курица», соль пищевая, бисглицинат железа, витамин D3, витамин В12.',
        protein: 9.5,
        fat: 15,
        carbs: 16.7,
        kcal: 234,
